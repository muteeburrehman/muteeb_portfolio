...
export function Marquee({ hideOnContact }: MarqueeProps) {
  ...
  return (
    <div
      className="fixed right-0 bottom-0 left-0 z-30 overflow-hidden border-t border-white/5 bg-bg/85 backdrop-blur-md"
      aria-hidden="true"
    >
      <div className="relative py-3.5">
        ...
        <div className="flex w-max animate-marquee">
          <span className="shrink-0 px-4 font-mono text-xs tracking-widest text-white/30">
            {TICKER}
          </span>
          <span className="shrink-0 px-4 font-mono text-xs tracking-widest text-white/30">
            {TICKER}
